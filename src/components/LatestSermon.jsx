      ...
      <div className="latest-sermon">
        {hasVideo && (
          <div className="latest-sermon-header">
            <h2 className="latest-label">
              {sermon?.isFallback ? "LIVESTREAM" : "LATEST SERMON"}
            </h2>
        ...
        <div className="sermon-video-wrapper">
          {hasVideo ? (
            <>
              ...
              <div className="fallback-link-wrapper">
                <a
                  ...
                  href={
                    sermon.fallbackUrl ||
                    "https://www.youtube.com/@LivingGraceMinistry"
                  }
                  target="_blank"
            ...
            // Extremely rare now, since hook sets a videoId for livestream fallback
            <YoutubeChannel />
          )}
        </div>
      </div>
